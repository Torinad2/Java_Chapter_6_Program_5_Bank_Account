...
public class BankAccount
{
    ...
    /**
     Constructor sets the starting balance at 0.0.
     */
    public BankAccount()
    {
        balance = 0.0;
    ...
    /**
     Constructor sets the starting balance at a specified value.
    ...
    /**
     Constructor sets the starting balance using
     the value passed as a String.
